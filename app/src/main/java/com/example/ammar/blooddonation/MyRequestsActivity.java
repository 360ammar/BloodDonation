...
public class MyRequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(MyRequestsActivity.this);
        ...
        mDatabase.child("users").child(userID.getUid()).child("acceptedDonors").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    RequestsAdapter adapter1 = new RequestsAdapter(userData);
