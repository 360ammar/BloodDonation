 ...
 * {@link AvailableDonors.OnFragmentInteractionListener} interface
...
public class AvailableDonors extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(AvailableDonors.this.getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_available_donors, container, false);
        rv = (RecyclerView) v.findViewById(R.id.rv_donors);
