 ...
 * {@link BloodRequest.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link BloodRequest#newInstance} factory method to
...
public class BloodRequest extends Fragment {
     ...
     * @return A new instance of fragment BloodRequest.
     */
    // TODO: Rename and change types and number of parameters
    public static BloodRequest newInstance(String param1, String param2) {
        BloodRequest fragment = new BloodRequest();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(BloodRequest.this.getActivity());
        ...
        mDatabase.child("recipient").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    final RVAdapter adapter1 = new RVAdapter(bloodList);
