...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryVH>{
    ...
    HistoryAdapter(List<UserProfile> userData){
    ...
    public HistoryVH onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        HistoryVH pvh = new HistoryVH(v);
        return pvh;
    }
    @Override
    public void onBindViewHolder(HistoryVH UserViewHolder, final int i) {

        UserViewHolder._Message.setText("You donated blood to " +  userData.get(i).getName());
            ...
            public void onClick(final View view) {
                ...
                ref.getRoot().child("users").child(userData.get(i).getUserID()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            recipientRating[0] = dataSnapshot.child("recipientRating").getValue(Float.class);
                        }
                    }
                    @Override
                ...
                updateButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ref.getRoot().child("users").child(userData.get(i).getUserID()).child("recipientRating").setValue((recipientRating[0] + ratingBar.getRating())/2);
                        rankDialog.dismiss();
                    }
                });
