...
public class Verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verID = (EditText)findViewById(R.id.verID);
        ...
        userLon = getIntent().getExtras().getDouble("Lon");
       verif = getIntent().getExtras().getString("verification");

       // Log.d("verifcation", verif + " " + phoneNum + "  -- " + _name + "  -- " + BloodGroup + "  -- "  );
...
// [END phone_auth_callbacks]
    ...
    private void verifyPhoneNumberWithCode(String verificationId, String code) {
        ...
        Log.d("Verifify", verificationId + " " + code);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            requestforBlood.setBloodGroup(BloodGroup);
                            requestforBlood.setDaterequested(timestamp);
                            requestforBlood.setUserID(user.getUid());
                            requestforBlood.setLat(userLat);
                            requestforBlood.setLon(userLon);
                            ...
                            // [START_EXCLUDE]
                            Intent intent = new Intent(getApplicationContext(),PostVerification.class);
...
// [END sign_in_with_phone]
    ...
    public void verifyCode (View v){
        String code = verID.getText().toString();
        if (TextUtils.isEmpty(code)) {
            verID.setError("Cannot be empty.");
            return;
        }
        verifyPhoneNumberWithCode(verif, code);
    }
    ...
    public void resendCode(View v){
        resendVerificationCode(phoneNum, MapsActivity.mResendToken);
    }
